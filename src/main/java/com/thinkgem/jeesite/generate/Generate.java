...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		...
		String moduleName = "eat";			// 模块名，例：sys
		String subModuleName = "";				// 子模块名（可选） 
		String className = "packageDish";			// 类名，例：user
		String classAuthor = "wjh";		// 类作者，例：ThinkGem
		String functionName = "套餐明细";			// 功能名，例：用户
